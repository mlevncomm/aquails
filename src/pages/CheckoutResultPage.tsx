...
export default function CheckoutResultPage() {
  ...
  return (
    <PageLayout>
      <div className="max-w-[640px] mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div className="bg-white border border-aq-border/60 rounded-[28px] shadow-sm shadow-aq-blue/[0.06] px-6 sm:px-10 py-12 text-center">
        {isSuccess ? (
          <>
            <motion.div
              initial={{ scale: 0 }}
            ...
            <p className="text-sm text-aq-muted mt-3">
          ...
          <>
            ...
            <h1 className="text-2xl font-bold text-aq-text mt-6">Ödeme Tamamlanamadı</h1>
            <p className="text-sm text-aq-muted mt-3">
