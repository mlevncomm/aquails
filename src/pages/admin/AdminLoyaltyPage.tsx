...
export default function AdminLoyaltyPage() {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <p className="text-sm text-[#8B9DAF] mb-6">Musteri puanlarini yonetin, kurallari duzenleyin.</p>
      ...
      <div className="bg-white border border-[#E8F0FE] rounded-2xl p-5 mb-6">
        <h3 className="text-sm font-semibold text-[#0D2137] mb-3">Manuel Puan Islemi</h3>
        <div className="flex gap-3">
          ...
          <input value={reason} onChange={e => setReason(e.target.value)} placeholder="Aciklama" className="flex-1 px-3 py-2 text-sm border border-[#D6E3F0] rounded-lg bg-[#F8FBFF]" />
      ...
      <div className="bg-white border border-[#E8F0FE] rounded-2xl p-5">
        ...
        <table className="w-full">
          <thead><tr className="border-b border-[#E8F0FE]"><th className="text-left px-3 py-2 text-xs font-semibold text-[#8B9DAF]">Islem</th><th className="text-right px-3 py-2 text-xs font-semibold text-[#8B9DAF]">Puan</th></tr></thead>
          <tbody>
            {EARN_RULES.map((r, i) => (
